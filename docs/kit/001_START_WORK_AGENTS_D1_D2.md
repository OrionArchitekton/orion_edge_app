...
> **Note:** Canonical deliverables live in `orchestrator_kit/`. Paths below already point to the new directories—do not recreate files under `docs/kit/` or `agent_workspaces/`.
...
Touch ONLY these files/folders: `orchestrator_kit/guides/slack_channels.md`, `orchestrator_kit/automation/webhook_contracts.json`.

Deliverables
1) `guides/slack_channels.md` – mark webhook URLs (mask tokens), and paste channel list + pins.
...
Touch ONLY these files/folders: `orchestrator_kit/artifacts/01_stack.md`.

Deliverables
1) `artifacts/01_stack.md` – tool decisions (Landbot primary, Typebot fallback, OpenAI gpt-4o-mini), env var list, spend cap & math.
...
Touch ONLY these files/folders: `orchestrator_kit/artifacts/05_sheets_setup.md`.

Deliverables
1) `artifacts/05_sheets_setup.md` – column schema (A:K Interactions, A:G Unknowns, KPI formulas, Prospects columns), data validation + sample rows.
2) Paste the 4 shareable URLs under “Links” in `artifacts/05_sheets_setup.md`.
...
Repo: kit. Branch: feat/kit-bootstrap.
Touch ONLY these files/folders: `orchestrator_kit/guides/roles_matrix.md`.

Deliverables
1) Update `guides/roles_matrix.md` with owners + D1–D7 due.
...
Repo: kit. Branch: feat/kit-bootstrap.
Touch ONLY these files/folders: `orchestrator_kit/artifacts/02_scope_faq.csv`.
...
Repo: kit. Branch: feat/kit-bootstrap.
Touch ONLY these files/folders: `orchestrator_kit/artifacts/03_flow_spec.json`.
...
Repo: kit. Branch: feat/kit-bootstrap.
Touch ONLY these files/folders: `orchestrator_kit/artifacts/04_prompts.md`.

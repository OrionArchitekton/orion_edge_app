...
3) Run `docker compose -f cosmocrat_v1/deploy/cosmocrat-v1.compose.yml up -d` (or dry-run) and `python3 jobs/memory/consolidate.py --commit`; note results + Langfuse trace link in PR.
